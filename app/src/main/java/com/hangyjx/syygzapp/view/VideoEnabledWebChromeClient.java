...
public class VideoEnabledWebChromeClient extends WebChromeClient implements OnPreparedListener, OnCompletionListener, OnErrorListener
{
    ...
    public VideoEnabledWebChromeClient(View activityNonVideoView, ViewGroup activityVideoView)
    {
        ...
        this.progressBar= MyWebView.progressBar;
    ...
    public VideoEnabledWebChromeClient(View activityNonVideoView, MyWebView webView)
    {
        this.progressBar= MyWebView.progressBar;
        this.activityNonVideoView = activityNonVideoView;
        this.webView = webView;
    ...
    public VideoEnabledWebChromeClient(MyWebView webView)
    {
        this.progressBar= MyWebView.progressBar;
        this.webView = webView;
        this.isVideoFullscreen = false;
