...
import com.hangyjx.syygzapp.utils.DisplayUtils;
...
public final class CameraManager {
	...
	private static final int MAX_FRAME_WIDTH = 700;//扫描框的宽
	private static final int MAX_FRAME_HEIGHT = 700;//400此处修改 扫描框的宽高
...
//						MIN_FRAME_HEIGHT, MAX_FRAME_HEIGHT);
				...
				int height = context.getResources().getDisplayMetrics().heightPixels - DisplayUtils.dip2px(context,260);
//
				int leftOffset = (screenResolution.x - width) / 2;
