...
import com.hangyjx.syygzapp.asymmetricfingerprintdialog.server.StoreBackendImpl;
...
public class FingerprintModule {
    ...
    public static FingerprintModule mFingerprintModule;

    public static FingerprintModule getInstance(Context context){
        if(mFingerprintModule == null){
            FingerprintModule temp =   new FingerprintModule(context);
            mFingerprintModule = temp;
        }
        return mFingerprintModule;
    }
